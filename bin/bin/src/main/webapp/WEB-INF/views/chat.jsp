...
<div class="container">
 ...
 <input id="nombre" value="${alumno.nombre}" type="hidden">
	  ...
	  $("#btn-chat").click(function(event) {
		...
		var nombre = $('#nombre').val();
		 $("#mensaje").val("")
          ...
          <img src=\"http://placehold.it/50/55C1E7/fff&text="+nombre+"\" alt=\"User Avatar\" class=\"img-circle\" /> \
              </span> \
                  <div class=\"chat-body clearfix\">\
                      <div class=\"header\">\
                          <strong class=\"primary-font\">"+nombre+"</strong> <small class=\"pull-right text-muted\">\
		...
		$.post("/alumno/curso/chat/"+idCurso, {
			mensaje : mensaje,
			idAlumno : idAlumno,
