...
<main class="my-form">
    <div class="cotainer">
        <div class="row justify-content-center">
            <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">Registrar DUEÑO</div>
                        <div class="card-body">
                            <form name="my-form" method="POST" action="/registro/duenio">
                           
                                <div class="form-group row">
                                    <label for="full_name" class="col-md-4 col-form-label text-md-right">RFC</label>
                                    <div class="col-md-6">
                                        <input type="text" id="rfc" class="form-control" name="rfc" placeholder="RFC" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="phone_number" class="col-md-4 col-form-label text-md-right">Licencia</label>
                                    <div class="col-md-6">
                                        <input type="text" id="licencia" class="form-control" name="licencia" maxlength="10" placeholder="NO. LICENCIA" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="number" id="number" class="form-control" maxlength="10" name="celular" placeholder="NO. CELULAR" required>
                                    </div>
                                </div>
                                
                                 <div class="form-group row">
                                 <label for="full_name" class="col-md-4 col-form-label text-md-right">QUIERES SER CHOFER ?</label>
						<div class="dropdown">
							<select name="opcion" class="form-control" id="opcion">
