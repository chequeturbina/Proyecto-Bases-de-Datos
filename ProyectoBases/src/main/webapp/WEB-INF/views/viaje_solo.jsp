...
<main class="my-form">
    <div class="cotainer">
        <div class="row justify-content-center">
            <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">Formulario SOLO</div>
                        <div class="card-body">
                            <form name="my-form" method="POST" action="/pedir/viaje">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label for="full_name" class="col-md-4 col-form-label text-md-right">No. Pasajeros</label>
                                    <div class="col-md-6">
                                        <input type="number" id="pasajeros" class="form-control" name="pasajeros" placeholder="PASAJEROS" required>
                                    </div>
                                </div>
